...
int main(int argc, char** argv)
{
    ...
    //cout << "construyendo arboles" <<endl;
    qdag_rel_R.build_tree();
    qdag_rel_S.build_tree();
    qdag_rel_T.build_tree();
    //cout << "construcción de arboles terminada" <<endl;
    ...
    //cout << "h: " << (int) h  << endl;
    // join(Q,ranks,{att_R,att_S,att_T}, h, 4); // warmup join

    start = high_resolution_clock::now();

    Join_Result=join(Q,ranks,{att_R,att_S,att_T}, h, 4);
